...
SELECT 
 DATE_FORMAT('2012-12-31' + INTERVAL n DAY,'%Y%m%d') AS SK_DATA,
 '2012-12-31' + INTERVAL n DAY AS Full_Date,
 DATE_FORMAT('2012-12-31' + INTERVAL n DAY,'%Y') AS NR_ANO,
 DATE_FORMAT('2012-12-31' + INTERVAL n DAY,'%m') AS NR_MES,
 DATE_FORMAT('2012-12-31' + INTERVAL n DAY,'%M') AS NM_MES,
 DATE_FORMAT('2012-12-31' + INTERVAL n DAY,'%d') AS NR_DIA
FROM (
